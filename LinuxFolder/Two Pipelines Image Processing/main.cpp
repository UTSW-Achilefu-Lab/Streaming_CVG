...
int main()
{
    ...
    // Clinical headset : 172.17.140.192
    // Streaming headset : 172.17.141.124
    ...
    // cv::Mat visibleFrames_, irFrames_;
    // while (true)
    // {
    //     visibleCap >> visibleFrames_;
    //     capIR >> irFrames_;
    //     cv::imshow("visibleFrame", visibleFrames_);
    //     cv::imshow("irFrames_", irFrames_);
    ...
    while (true)
    {
        ...
        // cv::imshow("visibleFrame", visibleGrayFrame);
        // drop alpha
        ...
        // imshow("mergedFrame", mergedFrame);
